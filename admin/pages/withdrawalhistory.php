      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <button onclick="window.location.href='withdrawal.php'" class="btn btn-primary btn-sm my-3 " style="float: right; width: 160px;">Pending Withdrawal</button>
              <h6>Confirmed Withdrawals</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php
                      $withdrawal = getAllConfirmed('withdrawal');
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-secondary"><a href="#" class="text-white">Confirmed</a></span>
                      </td>
                    </tr>
                  <?php
                    }
