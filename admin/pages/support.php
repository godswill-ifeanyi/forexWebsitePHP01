      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <button onclick="window.location.href='supporthistory.php'" class="btn btn-primary btn-sm my-3 " style="float: right; width: 160px;">Request History</button>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php
                      $request = getAllPending('requests');
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-left">
                        <span class="text-secondary text-xs font-weight-bold "><?=$item['subject']?></span>
                      </td>
                      <td class="align-middle text-left">
                        <span class="text-secondary text-xs font-weight-bold "><?=$item['details']?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?=$item['created_on']?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success" onclick="return confirm('Have you resolved this request?')"><a href="script.php?support=<?=$item['id']?>" class="text-white">Confirm</a></span>
                      </td>
                    </tr>
                  <?php
                    }
