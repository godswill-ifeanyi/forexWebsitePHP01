                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?=$item['country']?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success" onclick="return confirm('Are you sure to delete this user?')"><a href="deleteuser.php?id=<?=$item['id']?>" class="text-white">Delete</a></span>
                      </td>
                    </tr>
                  <?php
                    }
