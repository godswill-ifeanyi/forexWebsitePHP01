      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <button onclick="window.location.href='deposithistory.php'" class="btn btn-primary btn-sm my-3 " style="float: right; width: 150px;">Deposit History</button>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Deposit Date</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      $deposit = getAllPending('deposit');
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success" onclick="return confirm('Are you sure to confirm this deposit?')"><a href="script.php?deposit=<?=$item['id']?>&amount=<?=$item['amount']?>&user_id=<?=$item['user_id']?>" class="text-white">Confirm</a></span>
                      </td>
                    </tr>
                  <?php
                    }
