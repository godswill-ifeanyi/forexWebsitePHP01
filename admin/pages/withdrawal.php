      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Withdrawal</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Withdrawal</h6>
        </nav>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <button onclick="window.location.href='withdrawalhistory.php'" class="btn btn-primary btn-sm my-3 " style="float: right; width: 160px;">Withdrawal History</button>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Withdrawal</th>
                  ...
                  <tbody>
                    <?php
                      $withdrawal = getAllPending('withdrawal');
                      if (mysqli_num_rows($withdrawal) > 0) {
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-left">
                        <span class="text-secondary text-xs font-weight-bold "><?=$item['wallet']?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?=$item['created_on']?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success" onclick="return confirm('Have you credited this user?')"><a href="script.php?withdrawal=<?=$item['id']?>" class="text-white">Confirm</a></span>
                      </td>
                    </tr>
                  <?php
                    }
